...
class RobotModel:
    ...
    Attributes:
        ...
        actuated_joint_to_link_idx: Array of shape (num_actuated_joints,).
            Maps each actuated joint (by index in `joint_names`) to the corresponding link index it actuates.
    """
    ...
    joint_axes: Array
    actuated_joint_to_link_idx: Array
